...
for ((startX, startY, endX, endY), text) in results:
    ...
    print("EndX" + str(endX))
    print("EndY" + str(endY))
    print("SizeImage"+str(image.shape[0]))
    print("SizeImage"+str(image.shape[1]))
    print("SizeOrig" + str(orig.shape[0]))
    print("SizeOrig" + str(orig.shape[1]))
